$(function(){
    ...
    if(one.text() != two.text()){
				one.css('background-image', 'url(rub.jpg)');
        one.toggleClass("down");
				two.css('background-image', 'url(rub.jpg)');
    ...
    function clicked(){
		...
		if($(this).hasClass("click")){
			...
			$(this).css('background-image', 'url(rub.jpg)');
			$(this).addClass("down");
			opened["1"] = new Object();
			clicks = 0;
		}
			...
			$(this).addClass("click");
			$(this).css('background-image', 'url(' +$(this).text()+ '.jpg)');
			if(clicks >= 2){
				opened["2"] = $(this);
				unflip();
				clicks = 0;
